...
-- MAGIC %md 
-- MAGIC Open the [Datawarehousing notebook]($./03-BI-data-warehousing/03-BI-Datawarehousing-iot-turbine) to start running your BI queries or access or directly open the <a href="/sql/dashboards/b23730c5-e621-4250-8fa9-bcdf5aba9fbf" target="_blank">Wind turbine sensor dashboard</a>
...
-- MAGIC %md
-- MAGIC
-- MAGIC Open the <a href='/sql/dashboards/deb72044-e1e1-4c71-b28b-9cc88ff3982f' target="_blank">DBSQL Predictive maintenance Dashboard</a> to have a complete view of your wind turbine farm, including potential faulty turbines and action to remedy that.
